...
Fitbit Integration(not properly integrated right now as I could not get the API key from Fitbit): Connect to your Fitbit account to automatically pull in sleep history, active zones, steps, and caloric output.
